...
describe('getParamsFromPath', function() {
    const cases = [
        {path: '/us/en-US/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/us/en-US', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/us/en', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/us/en/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/{COMMERCE-CLOUD-SITE-ID}/en-US/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/{COMMERCE-CLOUD-SITE-ID}/en/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/us/en-US/category/womens', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {
            path: '/{COMMERCE-CLOUD-SITE-ID}/en-US/category/womens',
            expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}
        },
        {path: '/en-US/category/womens', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/en/category/womens', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/category/womens', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/en/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/en', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/ca/', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'ca'}},
        {path: '/ca', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'ca'}},
        {path: '/', expectedRes: {site: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/?site=us', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {path: '/?site=us&locale=en', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en'}},
        {path: '/en-US/category/womens?site=us', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {
            path: '/us/category/womens?locale=en-US',
            expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}
        },
        {path: '/us/category/womens?locale=en', expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}},
        {
            path: '/category/womens?site={COMMERCE-CLOUD-SITE-ID}&locale=en-US',
            expectedRes: {siteRef: '{COMMERCE-CLOUD-SITE-ID}', localeRef: 'en-US'}
        },
        {
            path: '/category/womens?site={COMMERCE-CLOUD-SITE-ID}&locale=en-US',
