...
describe('getPathWithLocale', () => {
    ...
    test('getPathWithLocale returns expected for PLP', () => {
        const location = new URL('http://localhost:8080/uk/it-IT/category/newarrivals-womens')
    ...
    test('getPathWithLocale uses default site for siteRef when it is no defined in the url', () => {
        const location = new URL('http://localhost:8080/category/newarrivals-womens')
    ...
    test('getPathWithLocale returns expected for PLP without refine param', () => {
        const location = new URL(
            'http://localhost:8080/uk/it-IT/category/newarrivals-womens?limit=25&refine=c_refinementColor%3DBianco&sort=best-matches&offset=25'
        )
    ...
    test('getPathWithLocale returns expected for Homepage', () => {
        const location = new URL('http://localhost:8080/uk/it-IT/')
