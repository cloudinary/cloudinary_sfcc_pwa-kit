...
// Cloudinary Component to Render CLD images gallery and swatches on PDP
import CloudinaryImageGallery from '../../components/cloudinary-image-gallery'
import CloudinaryImageSwatches from '../../components/cloudinary-image-swatches'
...
const ProductView = ({
    ...
    var cloudinaryObj
    if (product && product.c_cloudinary) {
        cloudinaryObj = product.c_cloudinary
    }
    ...
    return (
        <Flex direction={'column'} data-testid="product-view">
            ...
            <Flex direction={['column', 'column', 'column', 'row']}>
                {/** Cloudinary Custom Code Starts */}
                {product && product.c_cloudinary && product.c_cloudinary.pdp ? (
                    <>
                        <Box flex={1} mr={[0, 0, 0, 6, 6]}>
                            <CloudinaryImageGallery
                                size={imageSize}
                                cloudinaryImageGallery={
                                    product && product.c_cloudinary
                                        ? product.c_cloudinary
                                        : null
                                }
                            />
                        </Box>
