...
import CloudinaryPlpImage from '../../components/cloudinary-plp-images'
...
const ProductTile = (props) => {
    ...
    const {currency, image, price, productName, productId, c_cloudinary} = product
        ...
        >
            <Box {...styles.imageWrapper}>
                <AspectRatio {...styles.image}>
                    ...
                    {product && c_cloudinary && c_cloudinary.plpEnabled ? (
                        <CloudinaryPlpImage
