...
export default {
    ...
    notes: {
        _type: 'simple_link',
        link:
            'https://zzrf-001.sandbox.us01.dx.commercecloud.salesforce.com/s/{COMMERCE-CLOUD-SITE-ID}/dw/shop/v21_3/baskets/9303c9065ccc5fa2c7fca1d4b4/notes'
    },
    order_total: 629.98,
    product_items: [
        {
            ...
            price_adjustments: [
                {
                    ...
                    promotion_id: 'FreeShippingAmountAbove150',
                    promotion_link:
                        'https://zzrf-001.sandbox.us01.dx.commercecloud.salesforce.com/s/{COMMERCE-CLOUD-SITE-ID}/dw/shop/v21_3/promotions/FreeShippingAmountAbove150'
                }
            ],
