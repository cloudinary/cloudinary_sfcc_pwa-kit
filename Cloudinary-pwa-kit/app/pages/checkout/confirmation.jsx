...
import CldCartItemVariantImage from '../../components/item-variant/cld-item-image'
...
const CheckoutConfirmation = () => {
    ...
    if (basket && basket._productItemsDetail) {
        Object.keys(basket._productItemsDetail).forEach((key) => {
            if (basket._productItemsDetail[key].c_cloudinary) {
                orderConfirmation = basket._productItemsDetail[key].c_cloudinary.orderConfirmation
                // Get CLD orderConfirmation attribute to render ClD Image on order Confirmation
            }       
        })
    }
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <Flex width="full" alignItems="flex-start">
                                                            ...
                                                            {/** Cloudinary Custom Code Starts */}
                                                            {orderConfirmation ? (
                                                                <CldCartItemVariantImage
                                                                pageType={'orderConfirmationImage'}
                                                                width="80px"
                                                                mr={2}
                                                                />
                                                            ) : (
