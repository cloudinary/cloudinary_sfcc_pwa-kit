...
// Cloudinary Component to Render CLD images on order-history
import CloudinaryLineItemImage from '../../components/cloudinary-lineItem-image'
                                    ...
                                    {order.productItems.map((item) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {productDetail && productDetail.c_cloudinary && productDetail.c_cloudinary.orderHistory ? (
                                                    <CloudinaryLineItemImage
                                                    pageType={'orderConfirmationImage'}
                                                    cldProduct={productDetail.c_cloudinary.orderConfirmationImage}
                                                    image={image}
                                                    />
                                                ): (
                                                    <Img
